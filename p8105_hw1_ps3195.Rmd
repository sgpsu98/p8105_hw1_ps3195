...
The name of this dataset is `r ds`. And variables in it are `r ls(penguins)`. There are three factors which are `species`, `island` and `sex`,five numeric vectors are `bill_length_mm`, `bill_depth_mm`,`flipper_length_mm`, `body_mass_g` and `year`.
...
The summary of these variables is: 
