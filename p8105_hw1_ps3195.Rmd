...
The name of this dataset is `r ds`. And there are three factors which are `species`, `island` and `sex`,five numeric vectors are `bill_length_mm`, `bill_depth_mm`,`flipper_length_mm`, `body_mass_g` and `year`.
